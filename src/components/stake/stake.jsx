...
class Stake extends Component {
  ...
  constructor(props) {
    ...
    if(pool && ['FeeRewards', 'Boost'].includes(pool.id)) {
    ...
    return (
      <div className={ classes.root }>
        ...
        <div className={ classes.overview }>
          ...
          <div className={ classes.overviewField }>
            <Typography variant={ 'h3' } className={ classes.overviewTitle }>Active Boosters</Typography>
            <Typography variant={ 'h2' } className={ classes.overviewValue }>{ pool.tokens[0].boosters ? pool.tokens[0].boosters : "0" }</Typography>
          </div>
          <div className={ classes.overviewField }>
      ...
      <div className={ classes.actions }>
        ...
        <div className={ classes.actionContainer}>
          <Button
            ...
            variant="outlined"
            color="primary"
            disabled={ !pool.boostingEnabled || (['Boost'].includes(pool.id) ?  (loading || !voteLockValid || !balanceValid) : loading) }
            onClick={ () => { this.navigateInternal('boost') } }
            >
            <Typography className={ classes.buttonText } variant={ 'h4'}>Buy Booster</Typography>
          </Button>
        </div>
        <div className={ classes.actionContainer}>
          <Button
  ...
  renderBoost = () => {
    ...
    return (
      <div className={ classes.actions }>
      <div className={ classes.overviewField }>
        <Typography variant={ 'h3' } className={ classes.overviewTitle }>Booster Price</Typography>
        <Typography variant={ 'h2' } className={ classes.overviewValue }>{ pool.tokens[0].boosterPrice[0] ? pool.tokens[0].boosterPrice[0].toFixed(4) : "0" }</Typography>
      </div>
      <div className={ classes.overviewField }>
        <Typography variant={ 'h3' } className={ classes.overviewTitle }>Boosted Balance</Typography>
        <Typography variant={ 'h2' } className={ classes.overviewValue }>{ pool.tokens[0].boosterPrice[1] ? pool.tokens[0].boosterPrice[1].toFixed(4) : "0" }</Typography>
      </div>
        <div className={ classes.stakeButtons }>
          <Button
            className={ classes.stakeButton }
  ...
  onBoost = () => {
    ...
    this.setState({ loading: true })
    dispatcher.dispatch({ type: BOOST, content: { asset: selectedToken } })
  }
